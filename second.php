...
<head>
    ...
    <title>Próximo estreno de Marvel</title>
    <link
  rel="stylesheet"
...
>
 ...
 <body>
    <main>
        <section>
             <img src="<?= $data["following_production"]["poster_url"]; ?>" width="325" alt="Poster de <?= $data["following_production"]["title"]; ?>"
        ...
        <hgroup>
            ...
            <p>Tipo de producción: <?= $data["following_production"]["type"] ?></p>
